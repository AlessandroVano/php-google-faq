...
<body>
    ...
    <main>
        <div class="request_answers">
            <?php foreach ($googleRequestAnswers as $key => $requestAnswers) {
               /*  var_dump($requestAnswers); */ ?>
               <h2> <?php echo $key; ?></h2>
               <p> <?php foreach ($requestAnswers as $name) { 
                   $paragrafi = explode('.', $name); ?>
